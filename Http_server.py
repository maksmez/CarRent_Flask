...
class Car(Base):
    ...
    @check_500
    @check_token
    @app.route('/cars/get', methods=['POST'])
    def get_car():
        """
    ...
    @check_500
    @check_token
    @app.route('/cars/get_cars', methods=['POST'])
    def get_cars():
        """
...
class Person(Base):
    ...
    @check_500
    @app.route('/clients/sign_up', methods=['POST'])
    def sign_up():
        """
    ...
    @check_500
    @app.route('/clients/sign_in', methods=['POST'])
    def sign_in():
        """
    ...
    @check_500
    @check_token
    @app.route('/clients/get_client', methods=['POST'])
    def get_client():
        """
    ...
    @check_500
    @check_token
    @app.route('/clients/del', methods=['POST'])
    def del_client():
        """
    ...
    @check_500
    @check_token
    @app.route('/clients/edit_pass', methods=['POST'])
    def edit_pass():
        """
    ...
    @check_500
    @check_token
    @app.route('/clients/edit_client', methods=['POST'])
    def edit_client():
        """
    ...
    @check_500
    @check_token
    @app.route('/clients/log_out', methods=['POST'])
    def log_out():
        """
...
class Contract(Base):
    ...
    @check_500
    @check_token
    @app.route('/orders/get_orders', methods=['POST'])
    def get_orders():
        """
...
class Favorite(Base):
    ...
    @check_500
    @check_token
    @app.route('/favorite/get', methods=['POST'])
    def get_favorites():
        """
